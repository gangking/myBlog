...
![](../static/img/mukeReactJiChu/redux.png)



Redux Flow

![](../static/img/mukeReactJiChu/reduxflow.png)
...
2. 点击’ [the instructions](https://github.com/zalmoxisus/redux-devtools-extension#usage) ‘进行配置
